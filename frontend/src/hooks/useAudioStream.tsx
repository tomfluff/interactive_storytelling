...
const useAudioStream = () => {
  ...
  const mediaSource = React.useRef<MediaSource | undefined>(undefined);
  const sourceBuffer = React.useRef<SourceBuffer | undefined>(undefined);
  const [isPlaying, setIsPlaying] = React.useState(false);
  const [isStreaming, setIsStreaming] = React.useState(false);
  const mimeType = "audio/mpeg";
  const abortController = React.useRef<AbortController | undefined>(undefined); // Add AbortController
